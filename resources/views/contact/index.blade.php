...
<head>
    ...
    <title>Contact - Étude Rapide</title>
...
<body class="bg-gray-50">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
            <div class="flex justify-between items-center">
                ...
                <nav class="hidden md:flex items-center gap-8">
                    ...
                    <a href="{{ route('contact.index') }}" class="text-purple-700 font-semibold">Contact</a>
                    @auth
    ...
    <section class="gradient-bg text-white py-20">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h1 class="text-5xl md:text-6xl font-bold mb-6 logo-text">Contactez-nous</h1>
                    ...
                    <form method="POST" action="{{ route('contact.submit') }}" class="space-y-6">
                        ...
                        <div>
                            ...
                            <input type="text" id="name" name="name" value="{{ old('name') }}" required
                                   class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:border-purple-700 focus:ring-2 focus:ring-purple-100 transition-all"
                        ...
                        <div>
                            ...
                            <textarea id="message" name="message" rows="6" required
                                      class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:border-purple-700 focus:ring-2 focus:ring-purple-100 transition-all resize-none"
                    ...
                    <div class="contact-card bg-white rounded-2xl shadow-xl p-8">
                        <div class="flex items-start gap-4">
                            ...
                            <div>
                                ...
                                <p class="text-gray-600">contact@etuderapide.com</p>
                                <p class="text-gray-600">support@etuderapide.com</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="contact-card bg-white rounded-2xl shadow-xl p-8">
                        <div class="flex items-start gap-4">
                            ...
                            <div>
                                ...
                                <p class="text-gray-600">+509 XXXX-XXXX</p>
                                <p class="text-sm text-gray-500 mt-1">Lun - Ven: 8h - 18h (HAT)</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="contact-card bg-white rounded-2xl shadow-xl p-8">
                        <div class="flex items-start gap-4">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-gray-500 mt-1">Disponible en ligne 24/7</p>
                            </div>
                        </div>
                    </div>

                    <!-- Social Media -->
                    <div class="bg-gradient-to-r from-purple-700 to-amber-500 rounded-2xl shadow-xl p-8 text-white">
                        <h3 class="text-xl font-bold mb-4">Suivez-nous</h3>
                        <div class="flex gap-4">
                            <a href="#" class="bg-white bg-opacity-20 hover:bg-opacity-30 p-3 rounded-lg transition-all">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
                <div class="bg-gray-50 rounded-xl p-6">
                    <h3 class="text-lg font-bold text-gray-900 mb-2">💳 Quels modes de paiement acceptez-vous?</h3>
                    <p class="text-gray-600">Nous acceptons MonCash, cartes de crédit/débit, et portefeuille virtuel.</p>
                </div>
                <div class="bg-gray-50 rounded-xl p-6">
                    <h3 class="text-lg font-bold text-gray-900 mb-2">🎓 Les certificats sont-ils reconnus?</h3>
                    <p class="text-gray-600">Oui, nos certificats sont reconnus et valorisent votre CV professionnel.</p>
                </div>
                <div class="bg-gray-50 rounded-xl p-6">
                    <h3 class="text-lg font-bold text-gray-900 mb-2">⏰ Puis-je apprendre à mon rythme?</h3>
                    <p class="text-gray-600">Absolument! Accès illimité 24/7 à tous vos cours achetés.</p>
                </div>
                <div class="bg-gray-50 rounded-xl p-6">
                    <h3 class="text-lg font-bold text-gray-900 mb-2">💬 Y a-t-il un support technique?</h3>
                    <p class="text-gray-600">Oui, notre équipe est disponible pour vous aider du lundi au vendredi.</p>
                </div>
            </div>
        </div>
    </section>
